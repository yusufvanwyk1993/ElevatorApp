...
public class FreightElevatorServiceTests
{
    [Fact]
    public void Constructor_InitializesElevatorProperties()
    {
        var loggerMock = new Mock<ILogger>();
        var service = new FreightElevatorService(1, loggerMock.Object, 10);
    ...
    public void AddRequest_DoesNotThrow_WhenElevatorNotFound()
    {
        ...
        // var loggerMock = new Mock<ILogger>();
        var service = new FreightElevatorService(1, logger, 10, 500);
