...
public class BaseElevatorServiceTests
{
    [Fact]
    public void Constructor_InitializesElevatorProperties()
    {
        var loggerMock = new Mock<ILogger>();
        var service = new BaseElevatorService(1, loggerMock.Object, 10, true, false, 1);
    ...
    public void AddRequest_DoesNotThrow_WhenElevatorNotFound()
    {
        ...
        // var loggerMock = new Mock<ILogger>();
        var service = new BaseElevatorService(1, logger, 10, true, false, 1);
